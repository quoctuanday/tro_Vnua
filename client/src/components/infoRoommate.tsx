                ...
                <div className="w-[50rem] max-h-[40rem] overflow-y-auto p-6 bg-white rounded-lg shadow-lg">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center">
                            ...
                            <p className="ml-2 text-gray-700">{roommate?.title}</p>
                        </div>
                        <div className="flex items-center">
                            <span className="font-semibold">Chủ sở hữu:</span>
                            <p className="ml-2 text-gray-700">{roommate?.ownerName}</p>
                        </div>
                        <div className="flex items-center">
                            <span className="font-semibold">Số điện thoại liên hệ:</span>
                            <p className="ml-2 text-gray-700">{roommate?.contactNumber}</p>
                        </div>
                        <div className="flex items-center">
                            <span className="font-semibold">Email liên hệ:</span>
                            <p className="ml-2 text-gray-700">{roommate?.contactEmail}</p>
                        </div>
                        <div className="flex items-center">
                            <span className="font-semibold">Vị trí:</span>
                            <p className="ml-2 text-gray-700">{roommate?.location.name}</p>
                        </div>
                        <div className="flex items-center">
                            <span className="font-semibold">Diện tích:</span>
                            <p className="ml-2 text-gray-700">{roommate?.acreage}</p>
                        </div>
                        <div className="flex items-center">
                            <span className="font-semibold">Giá:</span>
                            <p className="ml-2 text-gray-700">{roommate?.price}</p>
                        </div>
                        <div>
                            <span className="font-semibold">Mô tả:</span>
                            <p className="ml-2 text-gray-700">{roommate?.convenience}</p>
                        </div>
                    ...
                    >
                        {roommate?.isAvailable ? 'Bài đã duyệt' : 'Duyệt bài viết'}
                    </button>
                </div>
            </div>
        </div>
